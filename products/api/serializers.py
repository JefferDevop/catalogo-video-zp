...
# Nota: Ya no importamos ItemactItemSerializer para ahorrar memoria y carga

class ProductSerializer(serializers.ModelSerializer):
    class Meta:
        model = Product
        fields = [
            "codigo", "ref", "flag", "name_extend", "slug",
            "description", "images", "video_url", "image_alterna",
            "price_old", "price1", "qty", "price2", "active",
            "soldout", "offer", "home",
        ]
...
class CategoryProductSerializer(serializers.ModelSerializer):
    ...
    # Optimizamos itemactitemData para que devuelva un valor por defecto 
    # sin ejecutar ninguna lógica ni consulta SQL.
    itemactitemData = serializers.ReadOnlyField(default=None)
